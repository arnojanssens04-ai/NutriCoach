...
var NUTRITION_ADVICE_TEMPLATES = {
  ...
  increase_iron_sources_v1: {
    ...
    status: 'active',
    variants: [
      { when: 'hasSupplement', bodyTemplate: 'Un complément en fer a été indiqué dans votre profil. Cette observation du journal (apport moyen estimé à {{avg_intake}}{{unit}}/jour, référence {{daily_target}}{{unit}}/jour) reste affichée à titre informatif et ne porte pas d\'appréciation sur le complément lui-même. À discuter avec un professionnel.' },
      { when: 'veryLow', bodyTemplate: 'Apport en fer estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Le fer. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Le fer. Le fer contribue au transport de l\'oxygène dans le sang et à votre énergie au quotidien, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
  ...
  increase_calcium_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en calcium estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Le calcium. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Le calcium. Le calcium contribue à la solidité des os et des dents, et à la contraction musculaire, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  increase_fiber_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en fibres estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Les fibres. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Les fibres. Les fibres contribue au bon fonctionnement du transit intestinal et à la sensation de satiété, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  increase_omega3_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en oméga-3 estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Les oméga-3. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Les oméga-3. Les oméga-3 contribue à la santé cardiovasculaire et au bon fonctionnement du cerveau, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  increase_magnesium_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en magnésium estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Le magnésium. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Le magnésium. Le magnésium contribue au fonctionnement musculaire et nerveux, et à la gestion de la fatigue, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  increase_zinc_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en zinc estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Le zinc. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Le zinc. Le zinc contribue au système immunitaire et à la cicatrisation, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  ...
  increase_potassium_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en potassium estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Le potassium. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Le potassium. Le potassium contribue à l\'équilibre hydrique et au bon fonctionnement musculaire et cardiaque, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  ...
  increase_vitamin_b12_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en vitamine B12 estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : La vitamine B12. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : La vitamine B12. La vitamine B12 contribue à l\'énergie et au bon fonctionnement du système nerveux, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
  increase_protein_sources_v1: {
    ...
    variants: [
      ...
      { when: 'veryLow', bodyTemplate: 'Apport en protéines estimé à {{avg_intake}}{{unit}}/jour en moyenne sur la période analysée, très en dessous de la référence de {{daily_target}}{{unit}}/jour (observation du journal, pas un diagnostic). Aliments à ajouter : {{foods}}. À discuter avec un professionnel.' },
      { when: 'default', bodyTemplate: '💡 Point d\'attention : Les protéines. Apport estimé à {{avg_intake}}{{unit}}/jour en moyenne, sous la référence de {{daily_target}}{{unit}}/jour sur la période analysée. Idées à intégrer selon vos préférences : {{foods}}. Constat indicatif basé sur votre journal, à faire valider avec votre diététicien.' },
      ...
      { when: 'default', bodyTemplate: '🔬 Observation micronutriments : Les protéines. Les protéines contribue à la construction et à la réparation musculaire, et à la sensation de satiété, mais l\'apport moyen relevé ({{avg_intake}}{{unit}}/jour) reste sous la référence de {{daily_target}}{{unit}}/jour sur la période. Pour en ajouter facilement : {{foods}}. Il s\'agit d\'une observation de votre journal, sans dosage médical.' }
    ],
    allowedVariables: ['foods', 'avg_intake', 'daily_target', 'unit']
  },
