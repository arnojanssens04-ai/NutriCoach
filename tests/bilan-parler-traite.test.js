...
check('7. dashboard.html, conseils.html, bilan.html, trend-engine.js, trend-definitions.js restent inchangés', () => {
  ['dashboard.html', 'conseils.html', 'bilan.html', 'trend-engine.js', 'trend-definitions.js'].forEach((f) => {
