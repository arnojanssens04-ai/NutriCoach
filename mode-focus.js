...
function renderBalancedPlate(entries){
  ...
  var tgt = calcTargets();
  var totalExpectedWeight = tgt.kcal * 0.55; // heuristique poids alimentaire total/jour
  var gramTgt = {
    veg: totalExpectedWeight * plateTgt.veg/100,
    prot: totalExpectedWeight * plateTgt.prot/100,
    starch: totalExpectedWeight * plateTgt.starch/100,
    fat: totalExpectedWeight * plateTgt.fat/100
  };
