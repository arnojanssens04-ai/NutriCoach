...
function renderBalancedPlate(entries){
  ...
  //
  // IMPORTANT \u2014 les cibles partent des VRAIS besoins en nutriments
  // (tgt.prot, tgt.gluc, tgt.lip) mais sont ensuite RAMEN\u00c9ES \u00e0 un poids
  // alimentaire total r\u00e9aliste pour la journ\u00e9e. Sans \u00e7a, chaque cat\u00e9gorie
  // \u00e9tait calcul\u00e9e ind\u00e9pendamment, comme si elle avait tout le budget
  // calorique pour elle seule \u2014 en pratique, atteindre 100% sur les 4 en
  // m\u00eame temps demandait ~3kg de nourriture par jour, ce qui n'a aucun
  // sens. En redistribuant proportionnellement sur un poids total
  // r\u00e9aliste, 100% sur chaque cat\u00e9gorie redevient un vrai objectif
  // atteignable pour une journ\u00e9e bien r\u00e9partie, sans perdre le lien avec
  // les vrais besoins (les proportions RELATIVES entre cat\u00e9gories restent
  // fid\u00e8les \u00e0 ce que le profil demande vraiment).
  var tgt = calcTargets();
