...
function renderBalancedPlate(entries){
  ...
  // Dimension ultra-transform\u00e9 \u2014 r\u00e9utilise la m\u00eame d\u00e9tection que le Score
  // Sant\u00e9 (signal explicite IA/NOVA en priorit\u00e9, mots-cl\u00e9s en repli) pour ne
  // jamais avoir deux jugements diff\u00e9rents sur le m\u00eame repas. Ton
  // encourageant m\u00eame quand il y en a, pas de liste culpabilisante ici \u2014
  ...
  if(typeof getUltraProcessedList==='function'){
    var ultraToday = getUltraProcessedList(today_);
    var ultraN = ultraToday.length;
